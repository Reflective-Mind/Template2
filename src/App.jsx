...
const runEngineContractTests = (normalizerFn, allowlist) => {
    ...
    const executeCode = () => {
        ...
        try {
            ...
            if (ENV.isLocal && !contractTested.current) {
                runEngineContractTests(normalizeImports, allowlist);
