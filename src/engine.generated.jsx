...
const appJsSource = `import Page2 from './Page2';
...
const file_Page2_js = `import React from 'react';
...
export default function RootApp({ devKey }) {
    const initialFiles = {
        ...
        "Page2.js": file_Page2_js,
    };
    const { devEnabled, editEnabled } = getAccessControl(devKey || DEV_KEY);
